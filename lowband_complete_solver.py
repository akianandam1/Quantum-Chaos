...
# ========= USER PARAMS =========
SDF_PATH      = "potentials/channel2.npz"   # your φ (signed distance) NPZ (from png_to_sdf)
OUT_DIR       = "eigensdf/doublewell/channel2"           # new output directory (do NOT reuse old one)
